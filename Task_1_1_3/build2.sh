...
javac -cp libs/junit-platform-console-standalone-1.11.0.jar ./src/main/java/ru/nsu/shirokov/* ./src/test/java/ru/nsu/shirokov/Test.java  -d ./build/classes/java/test
